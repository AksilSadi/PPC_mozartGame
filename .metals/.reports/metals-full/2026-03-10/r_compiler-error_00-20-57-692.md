...
class PlayerActor () extends Actor{
  ...
  def receive = {
    ...
    case Chord(time,l) => {
      l.foreach{ case (p,v,@@d) => 
        context.system.scheduler.scheduleOnce ((time) milliseconds) (note_on (p,v,10))
        context.system.scheduler.scheduleOnce ((time+500) milliseconds) (note_off (p,10))
      }
    }
