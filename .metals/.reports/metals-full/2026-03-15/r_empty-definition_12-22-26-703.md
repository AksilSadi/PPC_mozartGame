error id: file:///C:/Users/DELL/OneDrive/Bureau/sorbonne/M2/S2/PPC/mozartGame_code/src/main/scala/Player.scala:
...
non-local guesses:
	 -math/note.
	 -javax/sound/midi/note.
	 -javax/sound/midi/ShortMessage.note.
	 -scala/concurrent/duration/note.
	 -DataBaseActor.note.
	 -PlayerActor.note.
	 -note.
	 -scala/Predef.note.
...
class PlayerActor () extends Actor{
  ...
  def receive = {
    case Measure (chords) => {
      println("Je joue une measure")
      chords.foreach ( chord => 
      chord.notes.foreach ( note => 
        self ! MidiNote (note.pitch, n@@ote.vol, note.dur, chord.date)  
      )
      )
    }
